...
export class StorageService {
  ...
  static validateFile(file: File): { valid: boolean; error?: string; category?: string } {
  ...
  static getFileCategory(mimeType: string): string | null {
    ...
    if (FILE_VALIDATIONS.document.allowedTypes.includes(mimeType)) return 'document'
    return null
  }

  static async uploadFile(file: File, conversationId: string): Promise<UploadResult> {
