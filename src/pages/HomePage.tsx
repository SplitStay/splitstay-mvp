...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background py-0">
      {/* Header Navigation */}
      <header className="bg-background px-6 py-4 border-b border-gray-200">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link to="/" className="text-gray-700 hover:text-navy transition-colors font-medium border-b-2 border-navy pb-1">
              Home
            </Link>
            <Link to="/how-it-works" className="text-gray-700 hover:text-navy transition-colors font-medium">
              How it Works
            </Link>
            <Button 
              onClick={handleGetStarted}
              className="bg-navy text-white hover:bg-navy/90 px-6 py-2 rounded-lg font-medium"
            >
              Get Started
            </Button>
          </nav>
