...
function HowItWorks() {
  ...
  useEffect(() => {
    document.title = "How SplitStay Works - Share Hotel Rooms with Verified Travelers";
    
    const updateMetaTags = () => {
      const metaTags = [
        { name: 'description', content: 'Learn how SplitStay helps solo travelers save on hotel rooms by matching them with like-minded guests. Create your profile, match with verified travelers, and split costs.' },
        { property: 'og:title', content: 'How SplitStay Works - Share Hotel Rooms with Verified Travelers' },
        { property: 'og:description', content: 'Learn how SplitStay helps solo travelers save on hotel rooms by matching them with like-minded guests.' },
        { property: 'og:type', content: 'website' },
        { property: 'og:url', content: 'https://splitstay.travel/how-it-works' }
      ];
