...
import { MapPin, Calendar, Users, Building2, CalendarDays, ImageIcon, ArrowRight } from 'lucide-react';
            ...
            {trip.host?.imageUrl ? (
              ...
              <div className="flex items-center justify-center h-full">
                <div className="text-center">
                  ...
                  <p className="text-white/90 text-lg font-semibold">{trip.host?.name || 'Host'}</p>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    {roomSummary ? `${roomSummary.totalRooms} rooms` : 'View details'}
                  </p>
                </div>
              </div>
            ...
            {trip.thumbnailUrl ? (
              ...
              <div className="flex items-center justify-center h-full bg-gradient-to-br from-gray-400 to-gray-600">
                <div className="text-center">
                  ...
                  <p className="text-white/90 text-sm font-medium">{trip.location}</p>
                  <p className="text-white/70 text-xs">{trip.accommodation_type?.name || 'Accommodation'}</p>
                  <p className="text-white/60 text-xs mt-1">Preview not available</p>
                </div>
              </div>
            )}
